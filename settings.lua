...
local mod_id = "all_spell_wands" -- This should match the name of your mod's folder.
mod_settings_version = 1 -- This is a magic global that can be used to migrate settings to new mod versions. call mod_settings_get_version() before mod_settings_update() to get the old value. 
mod_settings = 
{
	{
		id = "random_chance",
		ui_name = "All Spell Wands weight",
		ui_description = "Chance of spawning wands with mostly random spells",
		value_default = 100,
		value_min = 0,
		value_max = 100,
	...
	{
		id = "vanilla_modified_chance",
		ui_name = "Modified Vanilla weight",
		ui_description = "Chance of spawning wands similar to vanilla, but with all kinds of spells",
		value_default = 0,
		value_min = 0,
		value_max = 100,
		value_display_multiplier = 1,
	...
	{
		id = "vanilla_chance",
		ui_name = "Vanilla weight",
		ui_description = "Chance of spawning vanilla wands",
		value_default = 0,
		value_min = 0,
		value_max = 100,
		value_display_multiplier = 1,
